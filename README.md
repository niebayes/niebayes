...
- [apache/doris](https://github.com/apache/doris) ([2.0.4-rc06](https://github.com/apache/doris/releases/tag/2.0.4-rc06), 2 days ago) - Apache Doris is an easy-to-use, high performance and unified analytics database.
...
- [chore: copy kafka remote wal doc from 0.5 to 0.6](https://github.com/GreptimeTeam/docs/pull/795) on [GreptimeTeam/docs](https://github.com/GreptimeTeam/docs) (5 days ago)
...
- [timescale/tsbs](https://github.com/timescale/tsbs) - Time Series Benchmark Suite, a tool for comparing and evaluating databases for time series data (5 days ago)
