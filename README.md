...
- [GreptimeTeam/greptimedb](https://github.com/GreptimeTeam/greptimedb) ([v0.7.0-nightly-20240304](https://github.com/GreptimeTeam/greptimedb/releases/tag/v0.7.0-nightly-20240304), 1 day ago) - An open-source, cloud-native, distributed time-series database with PromQL/SQL/Python supported.
- [apache/doris](https://github.com/apache/doris) ([2.0.5-rc02](https://github.com/apache/doris/releases/tag/2.0.5-rc02), 6 days ago) - Apache Doris is an easy-to-use, high performance and unified analytics database.
...
- [fix: mitigate memory spike during startup](https://github.com/GreptimeTeam/greptimedb/pull/3418) on [GreptimeTeam/greptimedb](https://github.com/GreptimeTeam/greptimedb) (4 days ago)
...
- [kaist-cp/cs420](https://github.com/kaist-cp/cs420) - KAIST CS420: Compiler Design (2023 Spring) (2 days ago)
- [kaist-cp/kecc-public](https://github.com/kaist-cp/kecc-public) - KECC: KAIST Educational C Compiler.  IMPORTANT: DON&#39;T FORK! (2 days ago)
