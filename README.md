...
- [apache/doris](https://github.com/apache/doris) ([2.0.7](https://github.com/apache/doris/releases/tag/2.0.7), 2 days ago) - Apache Doris is an easy-to-use, high performance and unified analytics database.
- [GreptimeTeam/greptimedb](https://github.com/GreptimeTeam/greptimedb) ([v0.8.0-nightly-20240325](https://github.com/GreptimeTeam/greptimedb/releases/tag/v0.8.0-nightly-20240325), 3 days ago) - An open-source, cloud-native, distributed time-series database with PromQL/SQL/Python supported. Available on GreptimeCloud.
...
- [feat: introduce wal benchmarker](https://github.com/GreptimeTeam/greptimedb/pull/3446) on [GreptimeTeam/greptimedb](https://github.com/GreptimeTeam/greptimedb) (3 weeks ago)
