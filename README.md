...
- [apache/doris](https://github.com/apache/doris) ([2.1.1-rc05](https://github.com/apache/doris/releases/tag/2.1.1-rc05), 2 days ago) - Apache Doris is an easy-to-use, high performance and unified analytics database.
- [GreptimeTeam/greptimedb](https://github.com/GreptimeTeam/greptimedb) ([v0.8.0-nightly-20240401](https://github.com/GreptimeTeam/greptimedb/releases/tag/v0.8.0-nightly-20240401), 4 days ago) - An open-source, cloud-native, distributed time-series database with PromQL/SQL/Python supported. Available on GreptimeCloud.
...
- [capnproto/capnproto-rust](https://github.com/capnproto/capnproto-rust) - Cap&#39;n Proto for Rust (4 days ago)
