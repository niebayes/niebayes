...
- [apache/doris](https://github.com/apache/doris) ([2.0.5-rc02](https://github.com/apache/doris/releases/tag/2.0.5-rc02), 2 days ago) - Apache Doris is an easy-to-use, high performance and unified analytics database.
- [GreptimeTeam/greptimedb](https://github.com/GreptimeTeam/greptimedb) ([v0.7.0-nightly-20240226](https://github.com/GreptimeTeam/greptimedb/releases/tag/v0.7.0-nightly-20240226), 4 days ago) - An open-source, cloud-native, distributed time-series database with PromQL/SQL/Python supported.
...
- [powerline/fonts](https://github.com/powerline/fonts) - Patched fonts for Powerline users. (3 days ago)
